...
|---|---|---|---|
| B-FE-01 | Нет создания admin при первом запуске | 🔴 Критично | ⬜ |
| B-FE-02 | Баг 401 в api.request() → silent redirect | 🔴 Критично | ⬜ |
| B-FE-03 | Sidebar теряет project_id при навигации | 🟠 Высокий | ⬜ |
| B-FE-04 | Нет формы создания проекта | 🟠 Высокий | ⬜ |
| B-FE-05 | Нет страницы управления пользователями | 🟠 Высокий | ⬜ |
| B-FE-06 | WebSocket лог в task.html не подключён | 🟠 Высокий | ⬜ |
| B-FE-07 | CRUD формы отсутствуют на 6 страницах | 🟡 Средний | ⬜ |
| B-FE-08 | Дублирование методов в app.js | 🟡 Средний | ⬜ |
| B-FE-09 | analytics.html без Chart.js | 🟡 Средний | ⬜ |
