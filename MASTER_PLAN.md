...
| P-05 | Убрать .unwrap() из API handlers (62 места) | 🟡 | M | ⬜ |
| P-06 | Structured JSON logging via tracing-subscriber | 🟡 | S | ⬜ |
| P-07 | /healthz + /readyz эндпоинты (K8s probes) | 🟡 | S | ⬜ |
| P-08 | Тесты критических путей (4 новых теста) | 🟡 | M | ⬜ |
...
| ID | Задача | Приоритет | Сложность | Статус |
|---|---|---|---|---|
| K-01 | Cluster-wide Events WebSocket stream | 🟠 | M | ⬜ |
| K-02 | YAML editor: inline dry-run tab | 🟡 | M | ⬜ |
...
| 5 | K-01: Events WebSocket stream | `api/handlers/kubernetes/events.rs` |
