...
> **Система плагинов для расширения функциональности Semaphore UI**
...
Система плагинов позволяет расширять функциональность Semaphore UI без изменения основного кода приложения.
